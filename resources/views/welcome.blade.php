...
<html>
	<head>
  	...
  	<title>Gamerheads Podcast &mdash; game reviews done right</title>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6 col-xs-6">
						<div id="gtco-logo"><a href="index.html">Gamerheads Podcast <em>.</em></a></div>
					</div>
		...
		<div class="gtco-container">
			<div class="row row-mt-15em">
				<div class="col-md-12 mt-text text-center animate-box" data-animate-effect="fadeInUp">
					<h1>We review <strong>games</strong></h1>
